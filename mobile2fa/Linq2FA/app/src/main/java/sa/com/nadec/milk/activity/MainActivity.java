...
import sa.com.nadec.milk.fragments.Linq2FAMainFragment;
import sa.com.nadec.milk.fragments.PinPasswordFragment;
...
import static sa.com.nadec.milk.fragments.steps.BarcodeVerificationStep.*;
        ...
        if(keyCode ==KeyEvent.KEYCODE_BACK)
        {
            ...
            if(manager != null){
                ...
                if(currentFragment != null){
                    ...
                    if(currentFragment instanceof Linq2FAMainFragment || currentFragment instanceof PinPasswordFragment)
                    {
                        finish();

...
public class Linq2FAMainFragment extends Fragment {
        ...
        try
        {
            ...
            closeAppBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    FragmentActivity activity = Linq2FAMainFragment.this.getActivity();
                    if (activity != null){
    ...
    private void BindValuesToView(LinearLayout otpView, EnvelopedData envelopedData) {
        ...
        long T = (System.currentTimeMillis() / (30L * 1000L));
        String otpValue = OTP.generate(envelopedData.getSeed(),String.valueOf(T),envelopedData.getNumDigits(),"totp");
